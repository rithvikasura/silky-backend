...
io.on('connection', (socket) => {
    ...
    socket.on('join-group', ({ groupId, userId }) => {
        ...
        // Update online list for everyone (including new user's info)
    ...
    socket.on('disconnect', () => {
        // Remove user from any group and update online lists
